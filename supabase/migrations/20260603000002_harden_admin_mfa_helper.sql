...
with check (private.is_admin_with_mfa());

create policy "admin products update" on public.products
for update to authenticated
using (private.is_admin_with_mfa())
with check (private.is_admin_with_mfa());
...
revoke all on function public.is_admin_with_mfa() from public, anon, authenticated;
drop function if exists public.is_admin_with_mfa();
